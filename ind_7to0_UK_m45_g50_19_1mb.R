...
plink.gen=read.plink("ind_7to0_UK_m45_g50_19.bed",
                     "ind_7to0_UK_m45_g50_19.bim",
                     "ind_7to0_UK_m45_g50_19.fam")
...
for (a in 1:block.nr){
  ...
  plink.block.x=read.plink("ind_7to0_UK_m45_g50_19.bed",
                           "ind_7to0_UK_m45_g50_19.bim",
                           "ind_7to0_UK_m45_g50_19.fam",select.snps=b.df$block.x.names)
...
saveRDS(results.array, file="ind_7to0_UK_m45_g50_19_1mb_res.RData")

if (length(diff.test)>0){
  saveRDS(diff.test, file="ind_7to0_UK_m45_g50_19_1mb_diff.RData")
}
